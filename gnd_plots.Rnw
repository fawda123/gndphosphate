...
p2 <- ggplot() + 
  geom_rect(data = events, aes(xmin = xmin, xmax = xmax, ymin = ymin, ymax = ymax),
    fill = 'lightgreen', alpha = 0.6) +
  geom_vline(xintercept = as.numeric(spill), colour = 'tomato', alpha = 0.6, size = 1) +
  geom_line(data = na.omit(toplodp), aes(x = datetimestamp, y = value)) +
...
p3 <- ggplot() + 
  geom_rect(data = events, aes(xmin = xmin, xmax = xmax, ymin = ymin, ymax = ymax),
    fill = 'lightgreen', alpha = 0.6) +
  geom_vline(xintercept = as.numeric(spill), colour = 'tomato', alpha = 0.6, size = 1) +
  geom_line(data = na.omit(toplosl), aes(x = datetimestamp, y = value)) +
...
p4 <- ggplot() + 
  geom_rect(data = events, aes(xmin = xmin, xmax = xmax, ymin = ymin, ymax = ymax),
    fill = 'lightgreen', alpha = 0.6) +
  geom_vline(xintercept = as.numeric(spill), colour = 'tomato', alpha = 0.6, size = 1) +
  geom_line(data = na.omit(toplotr), aes(x = datetimestamp, y = value)) +
...
p5 <- ggplot() + 
  geom_rect(data = events, aes(xmin = xmin, xmax = xmax, ymin = ymin, ymax = ymax),
    fill = 'lightgreen', alpha = 0.6) +
  geom_vline(xintercept = as.numeric(spill), colour = 'tomato', alpha = 0.6, size = 1) +
  geom_line(data = na.omit(toploph), aes(x = datetimestamp, y = value)) +
...
p1 <- ggplot(toplo, aes(x = date, y = value)) +
  geom_line() + 
  geom_point(aes(fill = Event), pch = 21, size = 2) +
